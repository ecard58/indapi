...
public class EmprestimoController {
	...
	@PutMapping
	public ResponseEntity<Emprestimo> autalizar(@RequestBody Emprestimo emprestimo) {
		return new ResponseEntity<>(emprestimoService.autalizarEmprestimo(emprestimo), HttpStatus.OK);
	}
